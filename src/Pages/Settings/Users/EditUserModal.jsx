...
const EditUserModal = ({ showModal, setShowModal, onUserAdded, user }) => {
  ...
  useEffect(() => {
    if (user) {
      setEditUser({
        ...
        roles: {
          canAddUsers: user.roles?.canAddUsers || false,
          canEditViewReports: user.roles?.canEditViewReports || false,
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-700">Update user information and permissions</p>
              </div>
            </div>
            <button
